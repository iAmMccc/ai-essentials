...
- [幻觉](understanding/hallucination/) — AI 为什么会一本正经地胡说八道，以及如何应对

## 用好 AI

- [Prompt](using/prompt/) — 提示词：用户与 AI 沟通的语言，决定输出质量的第一关
- [Rules](using/rules/) — 规范：让 AI 始终遵守的行为约束，写一次，持续生效
- [Skills](using/skills/) — 技能：把复杂任务封装成可复用的 AI 能力模块
- [Projects](using/projects/) — 项目空间：让 AI 持续理解你的项目，而不是每次从零开始
- [MCP](using/mcp/) — 连接协议：让 AI 能调用外部工具和数据源，从「给建议」到「真动手」
- [完整工作流](using/workflow/) — 串联：Prompt + Skills + Rules + Projects + MCP 如何协作
